...
import { SelectedEventsComponent } from './components/selected-events/selected-events.component';
...
export const routes: Routes = [
    ...
    { path: 'selectedEvents', component: SelectedEventsComponent, title: 'Список обраних подій' },
